...
*Configurações dos serviços estão localizadas no arquivo configs.md na raiz do projeto.*

### **Clone do projeto**

```bash
# Execute o comando git clone para realizar o clone do repositório
$ git clone https://github.com/eleazar-nascimento/ignews.git
...
# baixe o arquivo do stripe para escutar os webhooks e cole ele na raiz do projeto
$ yarn stripe
